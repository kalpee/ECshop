    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="font-semibold text-l mb-5">
                    <h3>第1条（個人情報）</h3>
                </div>
                <div class="mb-5">
                ...
                <div class="font-semibold text-l mb-3">
                ...
                <div class="ml-10 mb-5">
                    <ul class="list-decimal">
                        ...
                        <ul class="list-decimal ml-10 mt-5">
                            ...
                            <ul class="list-decimal ml-10 my-5">
                ...
                <ul class="list-decimal mb-5 ml-10">
                    <li>当社は，本人から個人情報の開示を求められたときは，本人に対し，遅滞なくこれを開示します。ただし，開示することにより次のいずれかに該当する場合は，その全部または一部を開示しないこともあり，開示しない決定をした場合には，その旨を遅滞なく通知します。なお，個人情報の開示に際しては，1件あたり1，000円の手数料を申し受けます。</li>
                        <ul class="list-decimal my-5 ml-10">
                ...
                <ul class="list-decimal ml-10 mb-5 space-y-1">
